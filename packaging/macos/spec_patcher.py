# Patch Deluge.spec to include site-packages data without touching stdlib
python3.11 -c "
import os, site
...
# Only walk site-packages for non-python data assets (skip stdlib completely)
